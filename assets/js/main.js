ezArabicVersion = "2.6.0 (Github Release)";
legacy_mode = "0";

// Initialize for Quill Toolbars
var toolbarOptions = [
  ['bold', 'italic', 'underline', 'strike','latin'],        // toggled buttons
...
var inputElement = new Quill('#editor', {
  modules: {
...
var outputElement = new Quill('#editor2', {
  modules: {
    toolbar: null
  },
  theme: 'snow'
